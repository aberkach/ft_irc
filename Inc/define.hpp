...
#define ERR_CANNOTSENDTOCHAN(nick, channel)                 ":"  SERVERNAME " 404 " + (nick) + " " + (channel) + " :Cannot send to channel\r\n"
#define ERR_TOOMANYTARGETS(nick)                            ":"  SERVERNAME " 407 " + (nick) + " :too many targets\r\n"
